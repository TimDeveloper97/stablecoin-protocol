...
const ETH_CONTRACT_ADDRESS = "0xf95df7cE882b9684E0bc369994511e60E4728E98"
...
const CONTRACT_NAME = "Eth";
const CONTRACT_NAME_UPPER = "ETH";
...
async function initialize() {
    ...
    const contract = await MyContract.attach(ETH_CONTRACT_ADDRESS);
